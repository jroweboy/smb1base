...
.export BlockBumpedChk, InitBlock_XY_Pos, BrickShatter, BumpBlock
...
GetAreaObjectID:
  ;   lda R0    ;get value saved from area parser routine
  ;   sec
...
MushroomBlock:
  ...
  beq WriteBlockType ; unconditional

FireFlowerBlock:
  lda #$01       ;load mushroom/fire flower into power-up type
  bne WriteBlockType ; unconditional
...
BrickQBlockMetatiles:
  .byte FIREFLOWER_BOX_METATILE, MUSHROOM_BOX_METATILE, $5f, $60 ;used by question blocks
...
SpawnPowerUp:
  ...
  sta Enemy_ID,y            ;special use slot of enemy object buffer
  lda Block_PageLoc,x       ;store page location of block object
  sta Enemy_PageLoc,y       ;as page location of power-up object
  lda Block_X_Position,x    ;store horizontal coordinate of block object
  sta Enemy_X_Position,y    ;as horizontal coordinate of power-up object
  lda #$01
  sta Enemy_Y_HighPos,y     ;set vertical high byte of power-up object
  lda Block_Y_Position,x    ;get vertical coordinate of block object
  sec
  sbc #$08                  ;subtract 8 pixels
  sta Enemy_Y_Position,y    ;and use as vertical coordinate of power-up object
.export CreatePowerupInSlotY
CreatePowerupInSlotY:
  lda #$01                  ;this is a residual jump point in enemy object jump table
  sta Enemy_State,y         ;set power-up object's state
...
PutBehind:
  lda #%00100000
  sta Enemy_SprAttrib,y     ;set background priority bit
  lda #Sfx_GrowPowerUp
